...
% personal data
\name{Alessio}{Rovere}
\name{GeoMarine Solutions s.r.l.}{}
\email{alessio.rovere@unive.it} 
\address{Via delle Aegue Marse 1 – 17200 Roccapepe a mare (GE)}
...
La società \textbf{GeoMarine Engineering s.r.l.} rappresentata dal Prof. Alessio Rovere (in seguito definito "committente"), nell’ambito delle proprie attività di supporto tecnico al \textbf{Comune di Borghetto Santo Spirito (SV)}, le conferisce con la presente l’incarico di elaborare una \textbf{valutazione della massima ingressione del runup costiero} durante un evento di mareggiata estrema.

\section*{1. Scopo dell’incarico}
Il presente incarico si inserisce nell’ambito delle attività promosse dal Comune di Borghetto Santo Spirito (SV) per il miglioramento della \textbf{resilienza costiera a eventi meteoromarini estremi} e per la predisposizione di \textbf{mappe di rischio e vulnerabilità} da utilizzare come supporto alla pianificazione territoriale e alla gestione delle emergenze.

L’obiettivo dell’attività è la \textbf{valutazione quantitativa della massima ingressione del runup costiero} lungo la fascia litoranea comunale, mediante l’applicazione di un \textbf{ensemble di modelli empirici di runup} su dati di riferimento forniti, relativi ad una mareggiata estrema selezionata dalla ditta incaricata, con opportuna giustificazione della scelta.

L’analisi dovrà consentire di individuare le aree potenzialmente soggette a \textbf{inondazione costiera durante eventi di mareggiata estrema}.

I risultati dovranno essere presentati in forma di \textbf{relazione tecnica}, corredati da una \textbf{mappa di inondazione potenziale} causata dal runup durante l'evento estremo selezionato, dalla discussione critica dei valori stimati e delle principali incertezze del metodo.  
...
Per lo svolgimento dell’incarico saranno resi disponibili tutti i materiali necessari all’elaborazione e alla rappresentazione dei risultati, attraverso una repository dedicata reperibile su \underline{\href{https://github.com/Alerovere/Esercitazione_GGG.git}{questa pagina}}

Il materiale comprende:
\begin{itemize}
  \item un \textbf{Digital Elevation Model (DEM) e una Ortofotografia} dell’area di studio ottenute da survey UAS, con risoluzione adeguata alla scala dell’analisi costiera. Sono fornite relazioni relative all'acquisizione di questi dati.
  \item un \textbf{notebook Jupyter (python)} contenente celle per scaricare i dati di onda, i modelli empirici di runup, le funzioni di calcolo ed esempi di visualizzazione dei risultati.
  \item \textbf{dati GNSS} relativi ad un evento di runup avvenuto tra il 9 e il 12 maggio 2026 sul litorale di Borghetto S.S.
\end{itemize}
...
Il gruppo di consulenza è incaricato dal committente di svolgere le attività elencate di seguito, seguendo le istruzioni contenute nel materiale fornito e nella presente lettera di incarico.  \\[1em]
...
\begin{enumerate}
  ...
  I risultati numerici dovranno essere verificati e, se necessario, confrontati con le formule di riferimento citate nel notebook e valutatati criticamente in seguito all'analisi dei dati GNSS raccolti sul campo e forniti dal committente.
  \item \textbf{Elaborazione e rappresentazione cartografica.}  
  Utilizzare i valori di runup ottenuti per l'evento estremo selezionato per generare, tramite \textbf{QGIS} o software equivalente, una o più mappe delle aree potenzialmente soggette a \textbf{inondazione costiera}.  

  \item \textbf{Redazione della relazione tecnica.}  
  Preparare una relazione sintetica (massimo 5 pagine, bibliografia esclusa) secondo lo schema seguente:
  \begin{itemize}
    \item \textbf{Introduzione} – contesto generale, obiettivi, e riferimenti bibliografici scientifico-tecnici sulle dinamiche costiere dell’area di studio;
    \item \textbf{Area di studio} – descrizione del contesto geografico e geomorfologico, con una mappa realizzata in QGIS;
    \item \textbf{Metodi e dati} – spiegazione delle formule di runup utilizzate e dei dati di input, con relative citazioni; 
...
\begin{itemize}
  \item \textbf{Novembre - Dicembre 2026 – Lavoro guidato}  
  In questi mesi, il gruppo di lavoro prenderà familiarità con gli strumenti, guidato durante brevi in classe e tramite tutorials online per la risoluzione di problemi con software e altre domande.   
  \item \textbf{30 Novembre e 14 Dicembre 2026 – Sessioni di lavoro.}  
  ...
  \item \textbf{15 dicembre 2026 – Consegna della relazione preliminare (entro le ore 23:59).}  
  ...
  \item \textbf{21 dicembre 2026 – Revisione e discussione guidata.}  
  ...
  \item \textbf{15 gennaio 2027 – Consegna finale (entro le ore 23:59).}  
  La versione definitiva della relazione dovrà essere caricata obbligatoriamente su \textbf{Moodle} entro questo termine, come \textbf{file PDF unico per gruppo}.  
...
\textbf{Le richieste di feedback o aiuto potranno essere formulate esclusivamente durante le sessioni in classe.}  Eventuali richieste via e-mail non verranno prese in considerazione, al fine di garantire equità tra tutti i gruppi di lavoro.

Si ricorda che \textbf{non saranno accettate consegne via e-mail} ma solo tramite la piattaforma Moodle.  
...
Ogni componente del gruppo è responsabile in solido della correttezza, completezza e originalità dell'intero lavoro. Eventuali inadempienze di membri del gruppo di lavoro dovranno essere segnalate tempestivamente al committente.

Non è consentita la collaborazione con altri gruppi o con persone non iscritte al corso, né lo scambio di codici, dati, elaborati o grafici prodotti nell’ambito dell’attività.  Tali restrizioni mirano a garantire \textbf{pari condizioni di lavoro e valutazione} per tutte le studentesse e tutti gli studenti coinvolti.

Eventuali collaborazioni esterne — ad esempio, per l’uso di dati o riferimenti aggiuntivi provenienti da enti o progetti scientifici — dovranno essere \textbf{esplicitamente dichiarate e approvate} dal committente prima della consegna della relazione finale.

Fatto salvo ove diversamente indicato dalle licenze di utilizzo, i materiali forniti nella repository di progetto sono di uso strettamente didattico e non possono essere utilizzati o ridistribuiti per fini diversi da quelli previsti dall’incarico.  Il riutilizzo di tali materiali in altri contesti richiede il consenso scritto del committente o del titolare dei diritti.
...
La valutazione del lavoro sarà effettuata in base a criteri tecnico–scientifici e formali, volti a premiare la qualità metodologica, la chiarezza espositiva e la coerenza complessiva dell’elaborato. Il punteggio complessivo massimo attribuibile è di \textbf{30 punti}, che concorrerà alla determinazione del voto finale dell’esercitazione. La lode verrà assegnata in presenza di analisi aggiuntive proposte o di elaborati di qualità particolarmente elevata, giudicata dal committente.
...
Un elaborato potrà essere considerato \textbf{insufficiente} qualora presenti gravi errori metodologici, carenze nella bibliografia o nella rappresentazione dei risultati, oppure in caso di plagio o mancata attribuzione delle fonti. L'uso di strumenti AI è consentito solo nel rispetto delle "Linee Guida per l’uso responsabile dell’IA generativa nel campo della didattica e dell’apprendimento" stilato dall'Università Ca' Foscari di Venezia e disponibile a \underline{\href{https://www.unive.it/pag/fileadmin/user_upload/ateneo/norme_regolamenti/regolamenti/servizi-informatici/Linee_Guida_IA_Didattica.pdf}{questa pagina}}

\section*{8. Corrispettivo, condizioni e valore formativo}
Il presente incarico rientra tra le attività previste dal corso universitario \textit{Geografia Fisica e Geomorfologia} del Corso di Laurea in Scienze Ambientali dell’\textbf{Università Ca’ Foscari Venezia}, a.a. 2026/2027.
...
Si invita ogni gruppo di lavoro a considerare l’attività non solo come un esercizio accademico, ma come una \textbf{simulazione realistica di consulenza tecnica ambientale}, in cui accuratezza, chiarezza e rispetto delle procedure costituiscono parte integrante della valutazione finale.  

\vspace{1em}
Il committente a disposizione per eventuali chiarimenti tecnici o metodologici durante lo svolgimento dell’attività.

\vspace{1em}
Distinti saluti, \\[1em]
\textbf{Dott. Alessio Rovere} \\
\textit{Responsabile tecnico – GeoMarine Solutions s.r.l.} \\[5em]


Per accettazione,
Il Gruppo di lavoro\\[1.5em]

Inserire nome del gruppo di lavoro \\[2.5em]
\rule{10cm}{0.7pt}\\[2.5em]


Componenti del gruppo di lavoro
Nome, Cognome, N. Matricola\\[2.5em]

\rule{12cm}{0.7pt}\\[2.5em]
